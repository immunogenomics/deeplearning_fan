...
def read_sc(trainData1,trainData2,trainLabel,tuneData1,tuneData2,tuneLabel,testData1,testData2,testLabel):
    
    train=DataSet(trainData1, trainData2, trainLabel)
    
    tune=DataSet(tuneData1, tuneData2, tuneLabel)

    test=DataSet(testData1, testData2, testLabel)
